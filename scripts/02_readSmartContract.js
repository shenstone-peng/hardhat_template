...
const main = async () => {
    ...
    let mnemonic = "bunker stairs over inherit mesh famous develop kiwi admit grace luxury route";
    let mnemonicWallet = ethers.Wallet.fromMnemonic(mnemonic);
    console.log("mnemonic: ", mnemonicWallet)
    let tmp = mnemonicWallet.connect(ethers.provider)
